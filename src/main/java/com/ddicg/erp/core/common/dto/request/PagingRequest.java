package com.ddicg.erp.core.common.dto.request;
...
public class PagingRequest {
    ...
    public java.util.Map<String, String> getOrders() { return new java.util.HashMap<>(); }
    public Integer getSize() { return true ? size : 10; }
    ...
    public Integer getPage() { return true ? page : 0; }
}
